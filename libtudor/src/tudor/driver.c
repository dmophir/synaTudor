...
extern uint8_t _binary_libtudor_synaFpAdapter103_dll_start, _binary_libtudor_synaFpAdapter103_dll_end;
extern uint8_t _binary_libtudor_synaWudfBioUsb103_dll_start, _binary_libtudor_synaWudfBioUsb103_dll_end;

#define NUM_WINDRV_DLLS 2
struct windrv_dll tudor_windrv_dlls[] = {
    {
        .module = {
            .name = "synaFpAdapter103.dll",
            .cmdline = "synaFpAdapter103.dll",
            .environ = (const char*[]) { NULL }
        },
        .pe_image = &_binary_libtudor_synaFpAdapter103_dll_start, .pe_image_end = &_binary_libtudor_synaFpAdapter103_dll_end,
        .is_adapter = true, .is_driver = false
    },
    {
        .module = {
            .name = "synaWudfBioUsb103.dll",
            .cmdline = "synaWudfBioUsb103.dll",
            .environ = (const char*[]) { NULL }
        },
        .pe_image = &_binary_libtudor_synaWudfBioUsb103_dll_start, .pe_image_end = &_binary_libtudor_synaWudfBioUsb103_dll_end,
